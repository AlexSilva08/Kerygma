...
monitor_principal = monitors[1]  # Monitor principal
...
###########################################################################
    ...
    ax6.set_title('default: no edges')
...
canvas_grafico_massa = Canvas(canvas_distr_massas, 
    ...
    highlightcolor="#A7BBCB",
    highlightbackground="#A7BBCB")
canvas_grafico_massa.place(relx=0.5, rely=0.5, anchor="center")  # Centralizado na tela
